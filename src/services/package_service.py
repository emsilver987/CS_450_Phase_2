...
async def upload_part(
    ...
    try:
        ...
        expires_at = datetime.fromisoformat(upload_info['expires_at'].replace('Z', '+00:00'))
...
async def commit_upload(
    ...
    try:
        ...
        s3_key = f"packages/{upload_info['pkg_name']}/{upload_info['version']}/package.zip"
        ...
        package_item = {
            ...
            'size_bytes': sum(int(part['ETag'].split('-')[1]) for part in parts if '-' in part['ETag'])
        }
