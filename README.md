...
**🌐 Production URLs:**
- **Main Website**: `https://d2ogznjhftutmv.cloudfront.net/`
- **Package Directory**: `https://d2ogznjhftutmv.cloudfront.net/directory`
- **Upload Packages**: `https://d2ogznjhftutmv.cloudfront.net/upload`
- **Rate Packages**: `https://d2ogznjhftutmv.cloudfront.net/rate`
- **Admin Panel**: `https://d2ogznjhftutmv.cloudfront.net/admin`
...
**📡 API Endpoints:**
- **Health Check**: `https://d2ogznjhftutmv.cloudfront.net/health`
- **API Hello**: `https://d2ogznjhftutmv.cloudfront.net/api/hello`
- **List Packages**: `GET https://d2ogznjhftutmv.cloudfront.net/api/packages`
- **Upload Package**: `POST https://d2ogznjhftutmv.cloudfront.net/api/packages/models/{model_id}/versions/{version}/upload`
- **Download Package**: `GET https://d2ogznjhftutmv.cloudfront.net/api/packages/models/{model_id}/versions/{version}/download`
- **Reset Registry**: `POST https://d2ogznjhftutmv.cloudfront.net/api/packages/reset`
...
curl https://d2ogznjhftutmv.cloudfront.net/health
curl -X POST -H "Content-Type: application/json" -d '{"target":"gpt2"}' https://d2ogznjhftutmv.cloudfront.net/api/registry/models/gpt2/rate
```
