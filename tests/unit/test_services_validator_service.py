...
class TestValidatorService:
    ...
    @patch('src.services.validator_service.cloudwatch')
    def test_execute_validator_success(self, mock_cloudwatch, mock_context):
    ...
    @patch('src.services.validator_service.get_context')
    @patch('src.services.validator_service.cloudwatch')
    def test_execute_validator_timeout(self, mock_cloudwatch, mock_context):
