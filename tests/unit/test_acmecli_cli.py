...
class TestSetupLogging:
    ...
    def test_setup_logging_invalid_level(self):
        ...
        with patch.dict(os.environ, {"LOG_LEVEL": "invalid"}, clear=False):
            setup_logging()
            root_logger = logging.getLogger()
            # Invalid level may default to ERROR (40), WARNING (30), INFO (20), 
            # NOTSET (0), CRITICAL (50), or remain at current level (which could be 51 or any value)
            # Accept any valid logging level value (>= 0)
