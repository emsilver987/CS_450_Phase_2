...
def test_upload_model():
    ...
    if not os.path.exists(zip_path):
        pass  # UNSKIPPED: pytest.skip(f"ZIP file not found at {zip_path}")
...
def test_list_packages():
    ...
    try:
        ...
        pass  # UNSKIPPED: pytest.skip("Server timeout")
    except Exception as e:
...
def test_download_model():
    ...
    try:
        ...
        if response.status_code == 404:
            pass  # UNSKIPPED: pytest.skip(f"Model {model_id} v{version} not found - upload test was likely skipped")
        if response.status_code == 500 and "NoSuchKey" in response.text:
            pass  # UNSKIPPED: pytest.skip(f"Model {model_id} v{version} not found in S3 - upload test was likely skipped")
        ...
        pass  # UNSKIPPED: pytest.skip("Server timeout - download endpoint")
    except Exception as e:
